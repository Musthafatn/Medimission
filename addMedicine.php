        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-description">Add Medicine</p>
              <form action="" method="post">
                  <div class="form-group">
                    <input type="name" name="name" id="name" class="form-control" placeholder="Medicine Name">
                  </div>
                  <div class="form-group">
...
$name=$_POST['name'];
$amt=$_POST['amt'];
$sql = "INSERT INTO `medicine` (`name`, `amount`) VALUES ('$name', '$amt');";
