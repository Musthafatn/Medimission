          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              // echo $$row['max'];
                  ...
                  $sql = "SELECT max(aid) as max FROM appointmentoffline";
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAppointment Date</label>
...
echo '<script>if(!alert("Booking Success")) document.location = "appointment.php";</script>';
}
else{
