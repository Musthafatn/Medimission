...
<body>
  ...
  <a href="adminHome.php" class="text-reset">Home</a>
 ...
 while($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
  ...
  // echo "<td><button type='submit' name='submit' class='btn btn-success' onclick=location.href='userHome.php' >Book Appointment</button></td>";
      ...
      <form action='' method='post'>
            <button name='delete' value='". $row['name'] ."' class='btn btn-success' onclick='confirm()'>Delete</button>
        </form>
...
if(mysqli_query($conn, $sql))
  header("location:doctorTableView.php");
