...
<body>
  ...
  <a href="staffHome.php" class="text-reset">Home</a>
  <?php
     include "connect.php";
 ...
 while($row = mysqli_fetch_array($result,MYSQLI_ASSOC))
  ...
  // echo "<td><button type='submit' name='submit' class='btn btn-success' onclick=location.href='userHome.php' >Book Appointment</button></td>";
      ...
      <form action='doctorschedule.php' method='post'>
            <button name='update' value='". $row['name'] ."' class='btn btn-success'>Schedule</button>
        </form>
